...
ellipsis_repr(PyObject *op)
{
	...
	return PyString_FromStringAndEncode("省略號", Source_Encoding);
}
...
slice_repr(PySliceObject *r)
{
	...
	s = PyString_FromStringAndEncode("切片(", Source_Encoding);
	comma = PyString_FromStringAndEncode(", ", Source_Encoding);
