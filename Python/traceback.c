...
static struct memberlist tb_memberlist[] = {
	...
	{"下個",	T_OBJECT,	OFF(tb_next)},
	{"tb_frame",	T_OBJECT,	OFF(tb_frame)},
	{"框",	T_OBJECT,	OFF(tb_frame)},
	{"tb_lasti",	T_INT,		OFF(tb_lasti)},
	{"最近",	T_INT,		OFF(tb_lasti)},
	{"tb_lineno",	T_INT,		OFF(tb_lineno)},
	{"行號",	T_INT,		OFF(tb_lineno)},
	{NULL}	/* Sentinel */
};
...
#define FMT "  檔案 \"%.500s\"; 第 %d 行 # 的 %.500s\n"
#else
	/* This is needed by Emacs' compile command */
#define FMT "  檔案 \"%.500s\", 第 %d 行的 %.500s\n"
#endif
