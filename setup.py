...
class PyBuildExt(build_ext):
    ...
    def detect_modules(self):
        ...
        exts.append( Extension('regex_cp', ['regexmodule_cp.c', 'regexpr.c']) )
        ...
        exts.append( Extension('array_cp', ['arraymodule_cp.c']) )
        # complex math library functions
        exts.append( Extension('cmath', ['cmathmodule.c'],
                               libraries=math_libs) )
        exts.append( Extension('cmath_cp', ['cmathmodule_cp.c'],
                               libraries=math_libs) )

        # math library functions, e.g. sin()
        exts.append( Extension('math',  ['mathmodule.c'],
                               libraries=math_libs) )
        exts.append( Extension('math_cp',  ['mathmodule_cp.c'],
                               libraries=math_libs) )
        ...
        exts.append( Extension('time', ['timemodule.c'],
                               libraries=math_libs) )
        exts.append( Extension('time_cp', ['timemodule_cp.c'],
                               libraries=math_libs) )
