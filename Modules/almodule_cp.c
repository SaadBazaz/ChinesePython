...
#ifdef AL_NO_ELEM		/* IRIX 6 */
	{"穝砞﹚",	(PyCFunction)al_NewConfig,	METH_VARARGS,	al_NewConfig__doc__},
	{"穝ゴ秨梆",	(PyCFunction)al_OpenPort,	METH_VARARGS,	al_OpenPort__doc__},
	{"硈钡",	(PyCFunction)al_Connect,	METH_VARARGS,	al_Connect__doc__},
	{"い耞",	(PyCFunction)al_Disconnect,	METH_VARARGS,	al_Disconnect__doc__},
	{"弄把计",	(PyCFunction)al_GetParams,	METH_VARARGS,	al_GetParams__doc__},
	{"砞把计",	(PyCFunction)al_SetParams,	METH_VARARGS,	al_SetParams__doc__},
	{"琩高",	(PyCFunction)al_QueryValues,	METH_VARARGS,	al_QueryValues__doc__},
	{"把计戈",	(PyCFunction)al_GetParamInfo,	METH_VARARGS,	al_GetParamInfo__doc__},
	{"眔戈方",	(PyCFunction)al_GetResourceByName,	METH_VARARGS,	al_GetResourceByName__doc__},
	{"琌兜",	(PyCFunction)al_IsSubtype,	METH_VARARGS,	al_IsSubtype__doc__},
#if 0
	/* this one not supported */
	{"砞﹚岿粇矪瞶",	(PyCFunction)al_SetErrorHandler,	METH_VARARGS,	al_SetErrorHandler__doc__},
#endif
#endif /* AL_NO_ELEM */
#ifdef OLD_INTERFACE
	{"ゴ秨梆",		(PyCFunction)al_openport,	METH_VARARGS},
	{"穝砞﹚",		(PyCFunction)al_newconfig,	METH_VARARGS},
	{"琩高把计",		(PyCFunction)al_queryparams,	METH_VARARGS},
	{"弄把计",		(PyCFunction)al_getparams,	METH_VARARGS},
	{"砞把计",		(PyCFunction)al_setparams,	METH_VARARGS},
	{"弄嘿",		(PyCFunction)al_getname,	METH_VARARGS},
	{"弄箇砞",		(PyCFunction)al_getdefault,	METH_VARARGS},
	{"弄程程",		(PyCFunction)al_getminmax,	METH_VARARGS},
#endif /* OLD_INTERFACE */
...
inital_cp(void)
{
	...
	m = Py_InitModule4("al_cp", al_methods,
