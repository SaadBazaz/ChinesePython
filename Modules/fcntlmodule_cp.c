...
static PyMethodDef fcntl_methods[] = {
	{"檔案控制",	fcntl_fcntl, METH_VARARGS, fcntl_doc},
	{"輸出入控制",	fcntl_ioctl, METH_VARARGS, ioctl_doc},
	{"檔案鎖",	fcntl_flock, METH_VARARGS, flock_doc},
	{"鎖檔",       fcntl_lockf, METH_VARARGS, lockf_doc},
	{NULL,		NULL}		/* sentinel */
};
...
initfcntl_cp(void)
{
	...
	m = Py_InitModule3("檔案控制", fcntl_methods, module_doc);
