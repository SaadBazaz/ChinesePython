...
static PyMethodDef time_methods[] = {
	{"時刻",	time_time, METH_OLDARGS, time_doc},
#ifdef HAVE_CLOCK
	{"時鐘",	time_clock, METH_OLDARGS, clock_doc},
#endif
	{"休息",	time_sleep, METH_OLDARGS, sleep_doc},
	{"格林時",	time_gmtime, METH_OLDARGS, gmtime_doc},
	{"本地時",	time_localtime, METH_OLDARGS, localtime_doc},
...
#endif
#ifdef HAVE_STRFTIME
	{"時間格式",	time_strftime, METH_VARARGS, strftime_doc},
#endif
#ifdef HAVE_STRPTIME
	{"字串轉時間",	time_strptime, METH_VARARGS, strptime_doc},
#endif
	{NULL,		NULL}		/* sentinel */
};
...
/* an almost duplication of same module but with chinese name */
DL_EXPORT(void)
inittime_cp(void)
{
	PyObject *m, *d;
	char *p;
	/* m = Py_InitModule3("時間", time_methods, module_doc); */
	m = Py_InitModule3("time_cp", time_methods, module_doc);
