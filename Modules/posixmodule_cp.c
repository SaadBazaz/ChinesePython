...
PyObject *
posix_cp_strerror(PyObject *self, PyObject *args)
{
	int code;
	char *message;
...
#endif
#ifdef HAVE_STRERROR
	{"strerror",	posix_cp_strerror, METH_VARARGS, posix_strerror__doc__},
#endif
#ifdef HAVE_FSYNC
...
#if ( defined(_MSC_VER) || defined(__WATCOMC__) ) && !defined(__QNX__)
#define INITFUNC initnt_cp
#define MODNAME "nt_cp"
#else
#if defined(PYOS_OS2)
#define INITFUNC initos2_cp
#define MODNAME "os2_cp"
#else
#define INITFUNC initcp_posix_cp
#define MODNAME "posix_cp"
#endif
#endif
