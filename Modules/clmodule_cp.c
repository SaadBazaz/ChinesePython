...
static PyMethodDef compressor_methods[] = {
	{"關閉",		clm_CloseCompressor}, /* alias */
	{"終止壓縮",	clm_CloseCompressor},
	{"壓縮",		clm_Compress},
	{"讀預設值",		clm_GetDefault},
	{"讀最小最大",		clm_GetMinMax},
	{"讀名稱",		clm_GetName},
	{"讀參數",		clm_GetParam},
	{"讀參數編號",		clm_GetParamID},
	{"讀參數組",		clm_GetParams},
	{"查詢參數組",		clm_QueryParams},
...
static PyMethodDef decompressor_methods[] = {
	{"關閉",		clm_CloseDecompressor},	/* alias */
	{"終止解壓",	clm_CloseDecompressor},
	{"解壓",		clm_Decompress},
	{"讀預設值",		clm_GetDefault},
	{"讀最小最大",		clm_GetMinMax},
	{"讀名稱",		clm_GetName},
...
initcl_cp(void)
{
	...
	m = Py_InitModule("cl_cp", cl_methods);
